...
object RingIcons {
    ...
    val EyeOff: ImageVector by lazy { glyph("eye-off") { stroke("M2 12s3.5 -7 10 -7s10 7 10 7s-3.5 7 -10 7s-10 -7 -10 -7Z", 3f); stroke("M4.5 19.5l15 -15", 3f) } }
    ...
    val Link: ImageVector by lazy { glyph("link") { stroke("M10 13a5 5 0 0 0 7.1 0l2 -2a5 5 0 0 0 -7.1 -7.1l-1.1 1.1", 2.6f); stroke("M14 11a5 5 0 0 0 -7.1 0l-2 2a5 5 0 0 0 7.1 7.1l1.1 -1.1", 2.6f) } }
    ...
    val Cube: ImageVector by lazy { glyph("cube") { stroke("M12 2l9 5l-9 5l-9 -5Z", 3f); stroke("M3 7v10l9 5l9 -5V7", 3f); stroke("M12 12v10", 3f) } }
    ...
    val Snow: ImageVector by lazy { glyph("snow") { stroke("M12 2.5v19", 2.8f); stroke("M4.2 6.7l15.6 10.6", 2.8f); stroke("M19.8 6.7L4.2 17.3", 2.8f); stroke("M9.3 4.2l2.7 1.8l2.7 -1.8", 2.8f); stroke("M9.3 19.8l2.7 -1.8l2.7 1.8", 2.8f) } }
