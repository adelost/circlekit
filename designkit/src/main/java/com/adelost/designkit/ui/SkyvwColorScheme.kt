...
data class SkyvwColorScheme(
    ...
    val container: Color,
    val subdued: Color,
    val altitude: SkyvwAltitudeColorScheme,
)
 ...
 */
data class SkyvwAltitudeColorScheme(
    val blue: Color,
...
object SkyvwColorSchemes {
    val SeaGlass = SkyvwColorScheme(
        theme = SkyvwColorTheme.SEA_GLASS,
        ...
        altitude = SkyvwAltitudeColorScheme(
    ...
    val Cyan = SkyvwColorScheme(
        theme = SkyvwColorTheme.CYAN,
    ...
    val Steel = SkyvwColorScheme(
        theme = SkyvwColorTheme.STEEL,
    ...
    val Violet = SkyvwColorScheme(
        theme = SkyvwColorTheme.VIOLET,
    ...
    val all: List<SkyvwColorScheme> = listOf(SeaGlass, Cyan, Steel, Violet)
    val default: SkyvwColorScheme = SeaGlass

    fun resolve(theme: SkyvwColorTheme): SkyvwColorScheme =
        all.first { it.theme == theme }
}

val LocalSkyvwColorScheme = staticCompositionLocalOf { SkyvwColorSchemes.default }

@Composable
fun SkyvwColorSchemeProvider(
    theme: SkyvwColorTheme,
    content: @Composable () -> Unit,
) {
    CompositionLocalProvider(
        LocalSkyvwColorScheme provides SkyvwColorSchemes.resolve(theme),
        content = content,
    )
}
...
fun skyvwBrandColor(
    ...
    SkyvwAccentStrength.ACTIVE -> LocalSkyvwColorScheme.current.active
    SkyvwAccentStrength.SUPPORTING -> LocalSkyvwColorScheme.current.supporting
    SkyvwAccentStrength.INACTIVE -> LocalSkyvwColorScheme.current.subdued
}
