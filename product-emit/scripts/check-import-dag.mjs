...
const expectedCore = new Set([
  ...
  "emit-config-values-kotlin", "emit-domain-graph", "emit-lanes-kotlin", "emit-machine-kotlin", "emit-machine-mermaid", "emit-machine-stately", "emit-scenes-kotlin", "emit-studio-trace-kotlin",
