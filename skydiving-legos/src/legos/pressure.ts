...
/**
 * WHAT: Collects pressure observations for an active recording operation.
 * WHY: Keeps recording sensor subscription separate from recorder ingestion and flight instrumentation.
 */
...
/**
 * WHAT: Routes recorded pressure observations into the active recording session.
 * WHY: Keeps recorder ingestion effects separate from sensor ownership.
 */
