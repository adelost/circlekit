...
data class ShowcaseGeneratedRenderScope(val artifactRef: String, val screenRef: String, val surface: String, val mountRef: String)
data class ShowcaseGeneratedInputSlot(val consumerPortRef: String, val producerPortRef: String, val contractRef: String, val required: Boolean)
data class ShowcaseGeneratedEventSlot(val sourcePortRef: String, val targetPortRef: String, val contractRef: String)
...
class ShowcaseGeneratedImmutableInputBundle private constructor(
    ...
    fun <T : Any> require(consumerPortRef: String): T = requireNotNull(values[consumerPortRef]) as T
    companion object {
        fun exact(contract: ShowcaseGeneratedRenderContract, values: Map<String, Any>): ShowcaseGeneratedImmutableInputBundle =
            ShowcaseGeneratedImmutableInputBundle(contract, values.toMap())
    }
}
...
object ShowcaseManifest {
    ...
    val rendererContracts: List<ShowcaseGeneratedRenderContract> = emptyList()
